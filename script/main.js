...
//     $('.gnb > li:first-child > a > .fa-caret-right').show();
//   }
//   if($('#portfolio').offset().top==0){
//     $('.gnb > li:nth-child(2) > a > .fa-caret-right').show();
//   }
//   if($('#gallery').offset().top==0){
//     $('.gnb > li:nth-child(3) > a > .fa-caret-right').show();
//   }
//   if($('#qna').offset().top==0){
//     $('.gnb > li:nth-child(4) > a > .fa-caret-righti').show();
//   }
//   if($('#contact').offset().top==0){
//     $('.gnb > li:last-child > a > .fa-caret-right').show();
//   }
// });
